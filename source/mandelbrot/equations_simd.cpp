...
)
{
    ...
    __m512i solved_its_vec = _mm512_set1_epi16(0);
    ...
    for (iteration_count iterations = 0; iterations < max_iters; iterations++) {
        ...
        input_vec_imag = _mm512_fmadd_pd(xy, two_vec, input_vec_constant_imags);
    ...
    _mm512_storeu_epi16(ret.data(), solved_its_vec);
